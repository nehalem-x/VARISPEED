...
window.Settings = (() => {
  ...
  const GROUPS = [
    ...
    },
    {
      ...
      fields: [
        ...
        { k: 'rate.smoothing', t: 'range', label: 'Suavização da mudança', d: 1200, min: 0, max: 1200, step: 40,
          fmt: (v) => +v === 0 ? 'Desligada' : `${v} ms`, bounds: true },
  ...
  const FIELD_HELP = {
    ...
    'rate.smoothing': 'Define quanto tempo o áudio leva para alcançar uma nova velocidade durante a reprodução. Em 0 ms, a mudança volta a ser instantânea.',
