...
- durante o burst curto da roda, a física continua avançando em todos os frames, mas as escritas de posição ficam consolidadas por até `72 ms`; as conexões usam o mesmo snapshot visual já composto nos nós, impedindo que linhas e círculos se separem, e uma posição integral é redesenhada imediatamente ao final. Arraste de nó nunca entra nessa consolidação;
